...
const PopularCard = (): ReactElement => {
      ...
      <div className="col-span-full sm:col-span-6 xl:col-span-3 bg-white shadow-lg rounded-sm border border-slate-200">
        <div className="flex flex-col h-full text-center p-5">
          <div className="grow mb-1">
            ...
            <h3 className="text-lg text-slate-800 font-semibold mb-1">{t('homepage.softSkills')}</h3>
          </div>
          <div>
            {/* <a className="text-sm font-medium text-indigo-500 hover:text-indigo-600" href="#0">{t('homepage.exploreCard')} -&gt;</a> */}
          </div>
        </div>
      </div>
      ...
      <div className="col-span-full sm:col-span-6 xl:col-span-3 bg-white shadow-lg rounded-sm border border-slate-200">
        <div className="flex flex-col h-full text-center p-5">
          <div className="grow mb-1">
            ...
            <h3 className="text-lg text-slate-800 font-semibold mb-1">{t('homepage.trending')}</h3>
          </div>
          <div>
            {/* <a className="text-sm font-medium text-indigo-500 hover:text-indigo-600" href="#0">{t('homepage.exploreCard')} -&gt;</a> */}
          </div>
      ...
      <div className="col-span-full sm:col-span-6 xl:col-span-3 bg-white shadow-lg rounded-sm border border-slate-200">
        <div className="flex flex-col h-full text-center p-5">
          <div className="grow mb-1">
            ...
            <h3 className="text-lg text-slate-800 font-semibold mb-1">{t('homepage.designTech')}</h3>
          </div>
          <div>
            {/* <a className="text-sm font-medium text-indigo-500 hover:text-indigo-600" href="#0">{t('homepage.exploreCard')} -&gt;</a> */}
          </div>
      ...
      <div className="col-span-full sm:col-span-6 xl:col-span-3 bg-white shadow-lg rounded-sm border border-slate-200">
        <div className="flex flex-col h-full text-center p-5">
          <div className="grow mb-1">
            ...
            <h3 className="text-lg text-slate-800 font-semibold mb-1">{t('homepage.appsSoftware')}</h3>
          </div>
          <div>
            {/* <a className="text-sm font-medium text-indigo-500 hover:text-indigo-600" href="#0">{t('homepage.exploreCard')} -&gt;</a> */}
          </div>
