...
export const { setNotification, addNotification, updateNotification, updateStatus, deleteNotification, updateAllStatus, removeAllNotificationsSlice, clearNotifications, setTotal } = notifySlice.actions
